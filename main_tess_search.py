...
sec2 = pd.read_csv('all_targets_S001_v1.txt', sep="\t")
sec3 = pd.read_csv('all_targets_S002_v1.txt', sep="\t")
sec4 = pd.read_csv(f'all_targets_S001_v1.txt', sep="\t")
sec5 = pd.read_csv('all_targets_S001_v1.txt', sep="\t")
sec6 = pd.read_csv('all_targets_S002_v1.txt', sep="\t")
sec7 = pd.read_csv(f'all_targets_S001_v1.txt', sep="\t")
sec8 = pd.read_csv('all_targets_S001_v1.txt', sep="\t")
sec9 = pd.read_csv('all_targets_S002_v1.txt', sep="\t")
sec10 = pd.read_csv(f'all_targets_S001_v1.txt', sep="\t")
sec11 = pd.read_csv('all_targets_S001_v1.txt', sep="\t")
sec12 = pd.read_csv('all_targets_S002_v1.txt', sep="\t")
sec13 = pd.read_csv('all_targets_S002_v1.txt', sep="\t")
